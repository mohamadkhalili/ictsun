<template>
  <header :ref="sliderRef" class="slider slider-prlx fixed-slider text-center">
    <div class="swiper-container parallax-slider">
      <swiper ref="mySwiper" :options="swiperOptions" @ready="handleSwiperReadied" class="swiper-wrapper">
        <swiper-slide v-for="slide in intro1Data" :key="slide.id" class="swiper-slide">
          <div class="bg-img valign DRTL" :style="`background-image: url(${slide.image})`" data-overlay-dark="6">
            <div class="container">
